		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sampleprojectsalesdocumentmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sampleprojectsalesdocumentmanagement-display": {
								"semanticObject": "sampleprojectsalesdocumentmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sample.project.salesdocumentmanagement",
									"url": sap.ui.require.toUrl("sample/project/salesdocumentmanagement")
								}
							}
						}
					}
